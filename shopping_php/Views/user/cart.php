...
<body>
    ...
    <table>
        <tr>
            ...
            <tr>
                ...
                <td><button class="delete" type="submit">消去</button></td>
                </form>
            </tr>
            <?php endforeach; ?>
    ...
    <div class="total_button"><button class="total" onclick="location.href='./buy.php'">レジに進む→</button></div>
    <?php else :?> 
        <div class="price_button"><p class="price">カートに商品がありません</p></div>
    <?php endif; ?>    

    


    <div class="cart"><a class="cart_link" href="./search.php">戻る</a></div>
